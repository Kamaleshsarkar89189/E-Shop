...
import ShopCard from "apps/user-ui/src/shared/components/cards/shop-cart";
            ...
            <div className="w-[90%] lg:w-[80%] m-auto">
                ...
                <div className="w-full flex flex-col lg:flex-row gap-8">
                    ...
                    <aside className="w-full lg:w-[270px] !rounded bg-white p-4 space-y-6 shadow-md">
                        ...
                        {/* Countries */}
                        <h3 className="text-xl font-Poppins font-medium border-b border-b-slate-3">
                            Countries
                        </h3>
                        <ul className="space-y-2 !mt-3">
                            {countries?.map((country: any) => (
                                <li key={country} className="flex items-center justify-between">
                                    <label className="flex items-center gap-3 text-sm text-gray-700 cu">
                                        <input
                                            type="checkbox"
                    ...
                    <div className="flex-1 px-2 lg:px-3">
                        {isShopLoading ? (
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 2xl:gr...">
