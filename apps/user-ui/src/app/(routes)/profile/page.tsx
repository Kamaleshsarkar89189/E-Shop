...
import OrdersTable from 'apps/user-ui/src/shared/components/tables/order-table';
                        ...
                        {activeTab === "Profile" && !isLoading && user ? (
                            <div className="space-y-4 text-sm text-gray-700">
                                <div className="flex items-center gap-3">
                                    <Image
                                        src={user?.avatar || "https://ik.imagekit.io/kamaleshsarkar/products/product-1756914790228_j8uNFD4Ac.jpg"}
                                        alt=""
                                        width={60}
                                        height={60}
                                        className='w-16 h-16 rounded-full border border-gray-200'
                                    />
                                    <button className="flex items-center gap-1 text-blue-500 text-xs font-semibold">
