...
const stripePromise = loadStripe("pk_test_51RxYbqAb77vizp1xlj07lQVEX6dDmRkrg2LxvUkK9vTYth8LIduN28MPOnFgM0ncv2uMigdRE9ZDTiGG74oI9qg800yPLymrn2")

// "pk_test_51RxYbqAb77vizp1xlj07lQVEX6dDmRkrg2LxvUkK9vTYth8LIduN28MPOnFgM0ncv2uMigdRE9ZDTiGG74oI9qg800yPLymrn2"
const Page = () => {
    ...
    useEffect(() => {
        const fetchSessionAndClientSecret = async () => {
            ...
            try {
                ...
                const fakeSeller = { stripeAccountId: "acct_1RxotzAMtBrxnOdr" };
                const sellerStripeAccountId = (sellers && sellers[0]?.stripeAccountId) || fakeSeller.stripeAccountId;
            ...
            <div className="flex justify-center items-center min-h-[60vh] px-4">
                <div className="w-full text-center">
                    ...
                    <button
                        ...
                        className="bg-blue-600 text-white px-5 py-2 rounded-md hover:bg-"
                    >
                        Back to Cart
                    </button>
                </div>
