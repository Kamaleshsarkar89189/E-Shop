        ...
        <div className='w-full rounded-md cursor-pointer bg-white border border-gray-200 shadow-md overflow-hidden transition'>
            ...
            <div className="h-[120px] w-full relative">
                <Image
                    src={
                        shop?.coverBanner ||
                        "https://ik.imagekit.io/kamaleshsarkar/products/product-1756914790228_j8uNFD4Ac.jpg"
                    }
                    alt="Cover"
                    fill
            ...
            <div className="px-4 pb-4 pt-2 text-center">
                ...
                <div className="mt-4">
                    <Link
                        href={`/shop/${shop.id}`}
                        className="inline-flex items-center text-sm text-blue-600 font-medium hover:underline hover:to-blue-700 transition"
                    >
                        Visit Shop
