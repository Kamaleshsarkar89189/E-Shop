...
const ProductCard = ({ product, isEvent }: { product: any; isEvent?: boolean }) => {
    ...
    return (
        <div className='w-full min-h-[350px] h-max bg-white rounded-lg relative'>
            ...
            {product?.stock <= 5 && (
                <div className="absolute top-2 right-2 bg-yellow-400 text-slate-700 text-[10px]">
                    Limited Stock
                </div>
            )}
            ...
            {isEvent && timeLeft && (
                <div className="mt-2">
                    <span className="inline-block text-xs bg-orange-100 text-o">
                        {timeLeft}
                    </span>
                </div>
            )}
            ...
            <div className="absolute z-10 flex flex-col gap-3 right-3 top-10">
                ...
                <ShoppingBag
                        ...
                        className="cursor-pointer text-[#4b5563] ho er:scale-110 transition"
                    />
                </div>
            </div>
