    ...
    return (
        <div className="flex justify-center items-center min-h-[80vh] px-4 my-10">
            <form className="bg-white w-full max-w-lg p-8 rounded-md shadow space-y-6"
                ...
                <div className="bg-gray-100 p-4 rounded-md text-sm text-gray-700 space-y-2 ma">
                ...
                <button
                    ...
                    className="w-full bg-blue-600 text-white py-2 rounded-lg font-medium hover:bg-blue-800"
                >
