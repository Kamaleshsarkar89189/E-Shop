      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <input
            ...
            {...register("newPassword", {
              ...
              validate: {
                ...
                hasUpper: (value) =>
                  /[A-Z]/.test(value) || "Must include an uppercase letter", // Corrected regex
                hasNumber: (value) =>
                  /\d/.test(value) || "Must include a number", // Completed this line
              },
            })}
            className='form-input'
        ...
        <div>
          ...
          <input
            ...
            className="form-input" // This is a placeholder for your input styling
