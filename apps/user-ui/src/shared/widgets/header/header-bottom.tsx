                ...
                {show && (
                    <div
                        className={`absolute left-0 ${isSticky ? "top-[70px]" : "top-[50px]"
                            } w-[260px] max-h-[400px] overflow-y-auto bg-white shadow`}
                    >
                                        ...
                                        >
                                            ...
                                            {hasSub &&
                                                (isExpanded ? (
                                                    ...
                                                    <ChevronRight className="w-4 h-4 text-gray-5" />
                                                ))}
                                        </button>
                                                ...
                                                {data.subCategories[cat].map(
                                                    (sub: string, j: number) => (
                                                        <Link
                                                            ...
                                                            className="block px-4 py-2 text-sm text-" // class name is cut off
