    ...
    const applyTransformation = async (effect: string) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                console.warn(`Effect ${effect} failed`, res.status);
                setSelectedImage(selectedImage); // fallback
            }
        } catch (error) {
                            ...
                            <div className='mt-2'>
                                <Input
                                    ...
                                    {...register("video_url", {
                                        pattern: {
                                            value:
                                                /^https:\/\/www\.(www\.)?youtube\.com\/embed\/[a-zA-Z0-9_-]+$/,
                                            message:
                                        ...
                                        {discountCodes?.map((code: any) => (
                                            <button
                                                ...
                                                className={`px-3 py-1 rounded-md text-sm font-semibold border ${watch(
                                                    "discountCodes"
                                                )?.includes(code.id) ? "bg-blue-600 text-white border-blue-600" : "bg-gray-800 text-gray-300 border-gray-600 hover:bg-gray-700"}`}
                                                onClick={() => {
                ...
                <div className='fixed top-0 left-0 w-full h-full flex items-center justify-center bg-black bg-opacity-60 z-50'>
                    <div className='bg-gray-800 p-6 rounded-lg w-[450px] text-white'>
                        <div className='flex justify-between items-center pb-3 mb-4'>
                            <h2 className='text-lg font-semibold'>Inhance Product Image</h2>
                            <X
                                size={20}
