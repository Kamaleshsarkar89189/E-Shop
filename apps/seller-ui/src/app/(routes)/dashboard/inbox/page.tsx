...
const ChatPage = () => {
  ...
  if (!socketContext) return null; // Prevent destructuring null
      ...
      <div className="flex h-screen shadow-inner overflow-hidden bg-gray-950 text-...">
        ...
        <div className="flex flex-col flex-1 bg-gray-950">
          {selectedChat ? (
              ...
              >
                {messages.map((msg: any, idx: number) => (
                  ...
                  >
                    ...
                    <div
                      className={`text-[11px] text-gray-400 mt-1 flex items-center g... ${msg.senderType === "seller" ? "mr-1 justify-end" : "ml-1"
                        }`}
                    >
            ...
            <div className="flex-1 flex items-center justify-center text-gray-500 te...">
