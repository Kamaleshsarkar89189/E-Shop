          ...
          <div className="bg-gray-800 p-6 rounded-lg w-[450px] shadow-lg">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="mt-4">
              ...
              <div className="mt-2">
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <select
                      {...field}
                      className="w-full px-3 py-2 text-base text-gray-200 bg-gray-800 border border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 appearance-none"
                    >
              ...
              <button
                ...
                className="mt-4 w-full flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white py-2 rounded-md"
              >
                <Plus size={18} />
